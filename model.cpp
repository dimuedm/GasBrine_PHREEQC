...
/*	debug_set = TRUE; */
	...
	for (;;)
	{
			   ...
			   || remove_unstable_phases == TRUE)
		{
            ...
            //Li Jun added for test
           /* for (int i = 0; i < count_master; i++)
            {
                if (master[i]->in > 0)
                {
                    std::cout << master[i]->in << std::endl;
                    std::cout << master[i]->gfw_formula << std::endl;
                    std::cout << master[i]->total << std::endl;
                    std::cout << std::endl;
                }
            }*/
